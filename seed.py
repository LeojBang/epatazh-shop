...
DATA = {
    ...
    "Муай-тай": {
        "slug": "muay-thai",
        "products": [
            ("Шорты Muay Thai Patriot", "shorts-muay-thai-patriot",
             "Классические тайские шорты с широкой резинкой и яркой сублимацией.",
             Decimal("2790.00"),
             [("S", 10), ("M", 14), ("L", 11), ("XL", 6)]),
            ("Рашгард Muay Thai Warrior", "rashgard-muay-thai-warrior",
             "Рашгард с длинным рукавом, дышащая ткань для интенсивных тренировок.",
             Decimal("3190.00"),
             [("S", 7), ("M", 10), ("L", 9), ("XL", 4)]),
            ("Футболка Muay Thai Fighter", "tshirt-muay-thai-fighter",
             "Футболка с тематическим принтом тайского бокса.",
             Decimal("1690.00"),
             [("S", 12), ("M", 16), ("L", 14), ("XL", 8)]),
            ("Майка Muay Thai Pro", "tank-muay-thai-pro",
    ...
    "Хоккей": {
        "slug": "hockey",
        "products": [
            ("Джерси хоккейное Classic", "jersey-hockey-classic",
             "Игровое джерси из дышащей сетчатой ткани, свободный крой.",
             Decimal("3490.00"),
             [("S", 6), ("M", 10), ("L", 12), ("XL", 8)]),
            ("Худи хоккейное Team", "hoodie-hockey-team",
             "Тёплое худи с командной символикой, плотный материал.",
             Decimal("4290.00"),
             [("S", 4), ("M", 7), ("L", 9), ("XL", 5)]),
            ("Футболка хоккейная Fan", "tshirt-hockey-fan",
             "Болельщицкая футболка из мягкого хлопка.",
             Decimal("1790.00"),
             [("S", 14), ("M", 18), ("L", 16), ("XL", 9)]),
            ("Поло хоккейное Club", "polo-hockey-club",
        ...
        for cat_name, cat_data in DATA.items():
            ...
            for name, slug, desc, price, sizes in cat_data["products"]:
                ...
                for size, stock in sizes:
                    db.add(ProductVariant(product_id=product.id, size=size, stock=stock))
