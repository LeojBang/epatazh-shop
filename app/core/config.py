...
class Settings(BaseSettings):
    ...
    # Автоматическое обновление статусов заказов через вебхуки СДЭК.
    # True  — статусы меняются сами (shipped/delivered) при уведомлении от СДЭК.
    # False — статусы меняются только вручную в админке.
    # Отключить быстро: CDEK_AUTO_STATUS=false в .env + перезапуск контейнера.
    CDEK_AUTO_STATUS: bool = True
